  ...
  describe '#serialized' do
    ...
    context 'a norden log' do
      ...
      context 'with standard parameters' do
        it { expect(create_wind_avg.speed_modified).to eq(8.2) }
        it { expect(create_wind_avg.gust_modified).to eq(12.1) }
      end
      ...
      context 'with minimum wind parameters' do
        ...
        it{ expect(create_wind_avg.speed_modified).to eq(0.6) }
        it { expect(create_wind_avg.gust_modified).to eq(1.1) }
      end
    end
    ...
    context 'a windguru log' do
      ...
      context 'with standard parameters' do
        it { expect(create_wind_avg.speed_modified).to eq(10.2) }
        it { expect(create_wind_avg.gust_modified).to eq(14.1) }
      end
